...
public:
    ...
    QPushButton *setControlPoint;
    QPushButton *clearControlPoint;
...
"background-color: rgb(85, 255, 255);"));
        ...
        show_axes->setGeometry(QRect(730, 20, 91, 21));
        ...
        DrawDDALine->setGeometry(QRect(710, 170, 111, 31));
        ...
        circle_radius->setGeometry(QRect(790, 140, 46, 20));
        ...
        draw_circle->setGeometry(QRect(700, 140, 91, 17));
        ...
        draw_line->setGeometry(QRect(720, 80, 77, 17));
        ...
        set_point1->setGeometry(QRect(810, 70, 81, 23));
        ...
        DrawBresenhamLine->setGeometry(QRect(830, 170, 141, 31));
        ...
        bresenhamMidpointCircle->setGeometry(QRect(1070, 230, 111, 31));
        ...
        xaxisRadius->setGeometry(QRect(950, 140, 42, 23));
        ...
        polarEllipse->setGeometry(QRect(710, 230, 111, 31));
        ...
        setVertex->setGeometry(QRect(980, 170, 101, 31));
        ...
        clearVertex->setGeometry(QRect(1090, 170, 91, 31));
        ...
        scanLineFill->setGeometry(QRect(940, 300, 101, 31));
        ...
        fill_selector->setGeometry(QRect(710, 300, 111, 31));
        ...
        boundaryFill->setGeometry(QRect(1050, 300, 111, 31));
        ...
        floodFill->setGeometry(QRect(830, 300, 101, 31));
        ...
        xtranslate->setGeometry(QRect(810, 350, 42, 23));
        ...
        ytranslate->setGeometry(QRect(950, 350, 42, 23));
        ...
        reflectionaxis->setGeometry(QRect(710, 470, 111, 21));
        ...
        drawAndStore->setGeometry(QRect(970, 90, 111, 31));
        drawAndStore->setCursor(QCursor(Qt::PointingHandCursor));
        label_13 = new QLabel(centralWidget);
        label_13->setObjectName("label_13");
        label_13->setGeometry(QRect(940, 60, 161, 31));
        QFont font;
        ...
        setControlPoint = new QPushButton(centralWidget);
        setControlPoint->setObjectName("setControlPoint");
        setControlPoint->setGeometry(QRect(720, 510, 111, 31));
        setControlPoint->setCursor(QCursor(Qt::PointingHandCursor));
        clearControlPoint = new QPushButton(centralWidget);
        clearControlPoint->setObjectName("clearControlPoint");
        clearControlPoint->setGeometry(QRect(840, 510, 111, 31));
        clearControlPoint->setCursor(QCursor(Qt::PointingHandCursor));
        drawBezierCurve = new QPushButton(centralWidget);
        drawBezierCurve->setObjectName("drawBezierCurve");
        drawBezierCurve->setGeometry(QRect(1000, 510, 131, 41));
        drawBezierCurve->setCursor(QCursor(Qt::PointingHandCursor));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        setControlPoint->setText(QCoreApplication::translate("MainWindow", "Set Control Point", nullptr));
        clearControlPoint->setText(QCoreApplication::translate("MainWindow", "Clear Control Point", nullptr));
        drawBezierCurve->setText(QCoreApplication::translate("MainWindow", "Draw Bezier Curve", nullptr));
